...
export class ConfigWebService {
  ...
  /*login(name: string, passwd: string): Observable<Hero> {
    ...
    //console.log("[info] Login Name : " + hero.name);
    //console.log("[info] Login Password  : " + hero.password);
    ...
    httpOptions)
      .pipe(
        map((data: any) => {
          console.log('[info] Recevied below input');
          console.log(data);
          //console.log(data.status);
          //console.log(data.statusCode);
          if(data.status == true){
              
              console.log("[info] Received response status is true" );
              this.mSharedPreferences.LOGIN_USERNAME(data.user.email);
              this.mSharedPreferences.LOGIN_STATUS("true");
              this.mSharedPreferences.LOGIN_PASSWORD(passwd);
          ...
          //console.log(data.user.customToken);
 ...
 login(name: string, passwd: string): Observable<Hero> {
  ...
  /*getImageFromService(imageName: string): Observable<Hero1>{
  ...
  */
  //async  getImageFromService(imageName: string) {
